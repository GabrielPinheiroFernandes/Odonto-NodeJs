...
async function addClient(clientData) {
  const { NOME, DATA_NASCIMENTO, SEXO, EMAIL, PLANO_SAUDE, OBSERVACAO } =
    clientData;
  ...
  return result
    ? { CODIGO, NOME, DATA_NASCIMENTO, SEXO, EMAIL, PLANO_SAUDE, OBSERVACAO }
    : null;
}
...
async function editClient(id, clientData) {
  ...
  return result && result.affectedRows > 0
    ? { id, NOME, DATA_NASCIMENTO, SEXO, EMAIL, PLANO_SAUDE, OBSERVACAO }
    : null;
}
